...
cin>>v[i];
    ...
    while(st.size()) {
        ...
        // while multiset conatins that element erase that element
        // and lower that element
    	//if the element when lowered by one does not 
    	// exist in multiset it means we have to add in another group
    
        // cout<<(st.find(x)!=st.end())<<"v"<<endl;
